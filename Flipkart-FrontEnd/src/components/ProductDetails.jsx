...
const ProductDetails = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <button
        onClick={() => navigate(-1)}
        className="bg-gray-200 hover:bg-gray-300 px-4 py-2 rounded-md mb-6 flex items-center"
      >
        ← Back to Products
      </button>
      ...
      <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-between">
          <div>
            ...
            <p className="text-blue-600 text-2xl font-semibold mt-2">₹{product.price}</p>
